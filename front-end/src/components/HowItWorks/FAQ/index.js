    ...
    return (
      <div className="faq">
        ...
        <Accordion>
          ...
          >
            <h4 className="faq__title">¿Quién es Ana?</h4>
            <Icon name="dropdown" />
          </Accordion.Title>
          <Accordion.Content active={activeIndex === 0}>
            <p>
              ...
              parcial- a las cuales cautelosamente se les hace una verificación
              de antecedentes (identidad, criminal y crédito), referencias y se
              lleva a cabo entrevistas personales. Son el tipo de persona que
              deseas en tu hogar: responsables, confiables, amigables e
              intuitivas. Antes de nuestra primera visita, nuestro equipo te
              presentará a tu Ana a través de correo electrónico (o en persona)
              para que sepas qué los hace tan especial.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 1}>
            <p>
              ...
              usted. Durante esta visita haremos un recorrido a su hogar para
              saber sus preferencias, aprender de su rutina, contestar cualquier
              pregunta y si usted lo desea y es necesario, adquirir una copia de
              sus llaves.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 2}>
            <p>
              ...
              de los bienes y servicios que usted recibió (Ej. compra, laundry,
              limpieza de hogar, sastre) semanalmente. Al final de la semana, se
              le enviará una factura y todos los recibos para que usted conozca
              exactamente por qué se le cobra esa cantidad. Pagos son procesados
              a través de Stripe, un sistema seguro y confiable por compañías
              mundiales. Se le aplicará un "fee" de procesamiento de la cantidad
              de 3.8% a facturas no relacionadas a la subscripciÃ³n. Este "fee"
              es para cubrir los costos misceláneos de procesamiento al agregar
              y pagar servicios a vendedores externos utilizados a través de
              Ana.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 3}>
            <p>
              ...
              las personas registradas. Ayúdate a ti (y a nosotros)... comparte
          ...
          <Accordion.Content active={activeIndex === 4}>
            <p>
              ...
              calidad. Para cualquier consultas y solicitudes especiales,
              "chatea" con nosotros presionando en el chat que aparece abajo en
              la esquina derecha o escríbenos a
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 5}>
            <p>
              ...
              ordene cada semana (Ej. compra de alimentos y hogar, "laundry",
              limpieza de hogar, etc). La cantidad facturada son precios del
              mercado o hasta mejores - no se le añade ningún precio adicional
              ni "fees" por entrega.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 6}>
            <p>
              ...
              Recuerde, que le facturaremos por el costo de los bienes y
              servicios que ordene cada semana.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 7}>
            <p>
              ...
              solo se mejora con el tiempo... así que es mejor probar el
              servicio por varios meses. Si usted decide poner su cuenta en
              "hold" o cancelar su membresía, solo deberá notificarnos con 10
              días anticipación a su próxima factura y haremos los arreglos
              pertinentes para no cobrarle.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 10}>
            <p>
              ...
              también aspiramos a trabajar con las pequeñas y medianas empresas
              (PyMES) del País sin comprometer el servicio ni la calidad.
            </p>
          </Accordion.Content>
          ...
          <Accordion.Content active={activeIndex === 11}>
            <p>
              ...
              embargo, precios pueden variar por vecindario y/o pueblo.
            </p>
          </Accordion.Content>
        </Accordion>
      </div>
