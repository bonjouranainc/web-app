  ...
  <div className="howItWorks wrapper">
    ...
    <div className="col group group1">
      ...
      <div className="cont">
        ...
        <p>
          Seleccione entre una variedad de servicios para el hogar y seleccione
          el día y hora que desea recibir el servicio
        </p>
      </div>
    </div>
    ...
    <div className="col group group3">
      <img src={url3} alt="" />
      <div className="cont">
        <h2>Voila! Todas sus tareas completadas</h2>
        <p>
